# src/app/views/mesas/nuevo_mesa_dialog.py
...
from ...services.mesas_service import crear_mesa, obtener_secciones
...
class NuevoMesaDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        if secciones:
            ...
            self.combo_seccion.addItems(["Principal", "Barra", "Privada"])
