...
from .controller import registrar_usuario
...
class NuevoUsuarioDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # Los roles pueden ser cargados dinámicamente desde controller en el futuro
    ...
    def validar_registro(self):
        ...
        ok = registrar_usuario(nombre, usuario, clave, rol)
        if ok:
