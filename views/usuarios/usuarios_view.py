from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QTableWidget, QTableWidgetItem, QHeaderView, QHBoxLayout, QMessageBox, QLineEdit
from PySide6.QtGui import QFont
from .nuevo_usuario_dialog import NuevoUsuarioDialog
from .editar_usuario_dialog import EditarUsuarioDialog
from .controller import obtener_usuarios, obtener_usuario_por_id, eliminar_usuario_por_id
...
class UsuariosView(QWidget):
    ...
    def eliminar_usuario(self):
        ...
        if respuesta == QMessageBox.Yes:
            if eliminar_usuario_por_id(usuario_id):
                self.cargar_usuarios()
